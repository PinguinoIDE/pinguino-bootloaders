...
#if defined(__XC8__) 
const struct {u8  bLength; u8  bDescriptorType; u16 str;} lang =
#else
const struct {u8  bLength; u8  bDescriptorType; u16 str;} lang =
#endif
{
...
#if defined(__XC8__) 
const struct {u8  bLength; u8  bDescriptorType; u16 string[9];} manu =
#else
const struct {u8  bLength; u8  bDescriptorType; u16 string[9];} manu =
#endif
{
...
#if defined(__XC8__) 
const struct {u8  bLength; u8  bDescriptorType; u16 string[8];} prod =
#else
const struct {u8  bLength; u8  bDescriptorType; u16 string[8];} prod =
#endif
{
...
#if defined(__XC8__) 
const struct {u8  bLength; u8  bDescriptorType; u16 string[8];} seri =
#else
const struct {u8  bLength; u8  bDescriptorType; u16 string[8];} seri =
#endif
{
