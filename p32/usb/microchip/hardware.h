...
// Pinguino 32MX220, 32MX250 and 32MX270
    ...
    #define mLED_Init()         TRISACLR = (1<<BOOTLED1) | (1<<BOOTLED2)
    ...
    */
    ...
    // Virtual address where bootloader code starts
    // ie. reset vector of the application code (_RESET_ADDR)
    //#define BootMemStart        0x9D001000
    //#define BootMemStart        0xBFC00000

    // Physical address where user program starts
    #define UserAppMemStart     0x1D006000
    #define BootMemStart        UserAppMemStart + 0x80000000
