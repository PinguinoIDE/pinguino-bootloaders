...
ifeq "$(wildcard nbproject/Makefile-local-32MX270.mk)" "nbproject/Makefile-local-32MX270.mk"
include nbproject/Makefile-local-32MX270.mk
endif
endif
...
SOURCEFILES_QUOTED_IF_SPACED=../lkr/crt0.S ../usb_descriptors.c ../main.c ../usb_device.c ../usb_function_hid.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/_ext/1360930308/crt0.o ${OBJECTDIR}/_ext/1472/usb_descriptors.o ${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1472/usb_device.o ${OBJECTDIR}/_ext/1472/usb_function_hid.o
POSSIBLE_DEPFILES=${OBJECTDIR}/_ext/1360930308/crt0.o.d ${OBJECTDIR}/_ext/1472/usb_descriptors.o.d ${OBJECTDIR}/_ext/1472/main.o.d ${OBJECTDIR}/_ext/1472/usb_device.o.d ${OBJECTDIR}/_ext/1472/usb_function_hid.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/_ext/1360930308/crt0.o ${OBJECTDIR}/_ext/1472/usb_descriptors.o ${OBJECTDIR}/_ext/1472/main.o ${OBJECTDIR}/_ext/1472/usb_device.o ${OBJECTDIR}/_ext/1472/usb_function_hid.o

# Source Files
SOURCEFILES=../lkr/crt0.S ../usb_descriptors.c ../main.c ../usb_device.c ../usb_function_hid.c
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-32MX270.mk dist/${CND_CONF}/${IMAGE_TYPE}/boot32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=32MX270F256B
MP_LINKER_FILE_OPTION=,--script="../lkr/32MX270F256B/procdefs.ld"
# ------------------------------------------------------------------------------------
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
dist/${CND_CONF}/${IMAGE_TYPE}/boot32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    ../lkr/32MX270F256B/procdefs.ld
...
dist/${CND_CONF}/${IMAGE_TYPE}/boot32.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk   ../lkr/32MX270F256B/procdefs.ld
	@${MKDIR} dist/${CND_CONF}/${IMAGE_TYPE} 
	${MP_CC} $(MP_EXTRA_LD_PRE)  -mprocessor=$(MP_PROCESSOR_OPTION) -nostartfiles -mno-float -o dist/${CND_CONF}/${IMAGE_TYPE}/boot32.X.${IMAGE_TYPE}.${DEBUGGABLE_SUFFIX} ${OBJECTFILES_QUOTED_IF_SPACED}          -Wl,--defsym=__MPLAB_BUILD=1$(MP_EXTRA_LD_POST)$(MP_LINKER_FILE_OPTION),-Map="${DISTDIR}/${PROJECTNAME}.${IMAGE_TYPE}.map",--report-mem,--verbose -G128
